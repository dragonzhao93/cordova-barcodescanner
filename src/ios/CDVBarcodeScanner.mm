...
- (UIView*)buildOverlayView {
    ...
    CGFloat x = (bounds.size.width - 220)*0.5;
    CGFloat y = (bounds.size.height - 220)*0.5;
    CGFloat height = 220;
    // 镂空
    ...
    [overlayView.layer addSublayer:shapLayer];
    ...
    [overlayView.layer addSublayer:cornerShapLayer];
...
- (CABasicAnimation *)positionBasicAnimate
{
    ...
    CGFloat y = (self.view.frame.size.height - 220)*0.5;
    CGFloat height = 220;
